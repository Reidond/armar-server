...
- **Context**: Example feature implementation — service was raising HTTPException directly
...
- **Context**: ExampleEntity session audio streaming — users reported truncated responses
